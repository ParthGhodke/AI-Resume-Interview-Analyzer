...
const Home = () => {
    ...
    const handleDropzoneClick = () => {
        console.log("Dropzone clicked, resumeInputRef:", resumeInputRef)
        console.log("resumeInputRef.current:", resumeInputRef.current)
        if (resumeInputRef.current) {
            console.log("About to click input element")
            resumeInputRef.current.click()
            console.log("Input clicked")
        } else {
            console.error("resumeInputRef.current is null!")
        }
    }
    ...
    const handleGenerateReport = async () => {
        ...
        console.log("Generating report with:", {
            ...
            selfDescription: selfDescription.substring(0, 50) + "..." || "none",
        ...
        try {
            ...
            if (data && data._id) {
                ...
                alert("Failed to generate interview report. No report ID received.")
